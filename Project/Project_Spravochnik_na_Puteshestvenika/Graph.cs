...
namespace Project_Spravochnik_na_Puteshestvenika
{
    public class Graph
    {
        ...
        private int Dijkstra(int start, int end, int way)
        {
             ...
             * 3: sort by price
            */
            /*ref Dictionary<string, int> cities = ref info.cities;
            ref var v = ref info.v;
            ref var unavaible_nodes = ref info.unavailable_nodes;
            ref var unavaible_edges = ref info.unavailable_edges;
            ref var distances = ref info.distances;*/
